...
groupDict = {'AST_A_BEFORE_SIZE': n.sum,
             'LOC_A_BEFORE_SIZE': n.sum,
             'AST_B_BEFORE_SIZE': n.sum,
             'LOC_B_BEFORE_SIZE': n.sum,
             'AST_A_TO_B': n.sum,
             'LOC_A_TO_B': n.sum,
             'AST_A_TO_SOLVED': n.sum,
             'LOC_A_TO_SOLVED': n.sum,
             'AST_B_TO_SOLVED': n.sum,
             'LOC_B_TO_SOLVED': n.sum,
             'IS_CONFLICT': any,
             'LOC_SIZE_SOLVED': n.sum,
             'NO_AUTHORS': n.sum,
             'LOC_DIFF_BEFORE': n.sum,
             'AST_DIFF_BEFORE': n.sum,
